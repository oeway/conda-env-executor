    ...
    if isinstance(source, (str, Path)):
        ...
        if isinstance(source, str) and '\n' in source:
            ...
            try:
                ...
                raise ValueError(f"Could not parse environment specification from string: {e}")
        ...
        # Handle file paths
        if not source_path.exists():
            raise FileNotFoundError(f"Environment specification file not found: {source_path}")
        ...
        try:
            ...
            raise ValueError(f"Could not parse environment specification from file: {e}")
